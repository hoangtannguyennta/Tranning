            ...
            <div class="form-bottom">
                ...
                <form action="{{ route('permission.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-content">
                        ...
                        <input class="input" type="text" id="fname" name="name" value="{{ old('name') }}" placeholder="Nhập tên quyền">
                        <label for="lname">{{ __('Mô tả quyền :') }}</label>
                        <input class="input" type="text" id="lname" name="display_name" value="{{ old('display_name') }}" placeholder="Mô tả quyền">
                    </div>
